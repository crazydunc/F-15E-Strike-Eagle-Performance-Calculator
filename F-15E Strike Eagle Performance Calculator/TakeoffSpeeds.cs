...
namespace F_15E_Strike_Eagle_Performance_Calculator
{
    public static class TakeoffSpeeds
    {
        public static string Calculate(double targetWeight, int centreGravity, int thrustSetting)
        {
            ...
            connection.Open();
            var rotationWeights = Worker.GetClosestDataPoints(connection, "GrossWeight", targetWeight, 2, centreGravity, thrustSetting);
            ...
            var interpolatedRotationSpeed = Worker.InterpolateNearestNeighbor(rotationWeights, speedData["Rotation"], targetWeight);
