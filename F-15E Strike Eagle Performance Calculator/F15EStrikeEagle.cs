...
namespace F_15E_Strike_Eagle_Performance_Calculator
{
    public static class F15EStrikeEagle
    {
        ...
        public static Station Station2A { get; set; } = new Station("STA2A");
        public static Station Station2 { get; set; } = new Station("STA2");
        public static Station Station2B { get; set; } = new Station("STA2B");
        public static Station LeftCft { get; set; } = new Station("LCFT");
        public static Station Ltp { get; set; } = new Station("LTP");
        public static Station Station5 { get; set; } = new Station("STA5");
        public static Station Lnp { get; set; } = new Station("LNP");

        public static Station RightCft { get; set; } = new Station("RCFT");
        public static Station Station8A { get; set; } = new Station("STA8A");
        public static Station Station8 { get; set; } = new Station("STA8");
        public static Station Station8B { get; set; } = new Station("STA8B");
        ...
        private static double CalculateDragIndex()
        {
            var dragIndex = BasicDragIndex + Station2A.StationDragIndex + Station2.StationDragIndex +
                         Station2B.StationDragIndex + LeftCft.StationDragIndex + Ltp.StationDragIndex + Station5.StationDragIndex +
                         Lnp.StationDragIndex + RightCft.StationDragIndex + Station8A.StationDragIndex + Station8.StationDragIndex +
