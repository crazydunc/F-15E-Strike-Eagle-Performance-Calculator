...
namespace F_15E_Strike_Eagle_Performance_Calculator
{
    ...
    {
        public Station(string stationName, string storeName = "", int storeWeight = 0, double storeDragIndex = 0.0, int storeQuantity = 0)
        {
        ...
        private void ValidateFuel()
        {
            if (StationName == "STA2")
            {
                if (!StoreName.Contains("610") && F15EStrikeEagle.Station2Fuel != 0)
                {
            ...
            {
                if (!StoreName.Contains("610") && F15EStrikeEagle.Station5Fuel != 0)
                {
            ...
            {
                if (!StoreName.Contains("610") && F15EStrikeEagle.Station8Fuel != 0)
                {
